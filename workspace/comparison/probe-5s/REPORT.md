# Stock-vs-zdtd comparison: probe-5s

- stock: ran 2026-08-12T08:31:44Z | loadgen c53dcf8 (dirty) | zdtd 6d25107 (dirty) | client count=1 actions=0 timeout=5000ms
- zdtd: ran 2026-08-12T08:32:34Z | loadgen c53dcf8 (dirty) | zdtd 6d25107 (dirty) | client count=1 actions=0 timeout=5000ms
...
| INF lines | 279 | 44 |
| WRN lines | 8 | 2 |
| telnet commands | 6 | n/a |

Boot evidence per side:
- `stock.StartGame done` = `StartGame done`
- `stock.createWorld` = `createWorld: Navezgane, Navezgane (src: GameData, DeviceLocal), probe-5s_stock, GameModeSurvival`
...
- `zdtd.save=` = `  save=/home/maci/Desktop/7dtd/7dtd-loadgen/workspace/comparison/probe-5s/zdtd/world`

## Telnet snapshot (gettime / listents / listplayers)

- stock day/time: Day 1, 07:00
- zdtd day/time: Day 1, 07:03
- clock rate (game-min per real-sec): stock=0.0 zdtd=0.4211 (60-min day = 0.4)
...
| entities alive | 6 | 10 |
| players | 0 | 0 |
- stock entity types: EntityZombie=6
- zdtd entity types: animal=1, trader=6, turret=1, vehicle=1, zombie=1
...
| Game name | probe-5s_stock | stock |
| Difficulty | 1 | 1 |
...
- stock: 5 file(s), 1 KiB
- zdtd: 11 file(s), 657 KiB
- stock keys: Navezgane/probe-5s_stock/blockmappings.nim, Navezgane/probe-5s_stock/itemmappings.nim, Navezgane/probe-5s_stock/main.ttw, Navezgane/probe-5s_stock/main.ttw.bak, Navezgane/probe-5s_stock/main.ttw.ext.bak
- zdtd keys: allies.zal, blockmeta.zbm, c_-17_27.zch, c_-17_28.zch, claims.zlc, clock.zcl, containers.zct, entities.zen
