# Stock-vs-zdtd comparison: join-fast-navezgane

- stock: ran 2026-08-12T12:40:28Z | loadgen 7f44170 (dirty) | zdtd edd9e16 (dirty) | client count=1 actions=0 timeout=60000ms
- zdtd: ran 2026-08-12T12:41:44Z | loadgen 7f44170 (dirty) | zdtd edd9e16 (dirty) | client count=1 actions=0 timeout=60000ms
...
| PASS joined | 1 | 1 |
| FAIL | 0 | 0 |
| first pass | `[2026-08-12T12:40:28.4294026Z] [join#1] PASS joined entity=177 w` | `[2026-08-12T12:41:43.9398285Z] [join#1] PASS joined entity=112 w` |
...
- `stock.createWorld` = `createWorld: Navezgane, Navezgane (src: GameData, DeviceLocal), join-fast-navezgane_stock, GameModeS`
...
- `zdtd.save=` = `  save=/home/maci/Desktop/7dtd/7dtd-loadgen/workspace/comparison/join-fast-navezgane/zdtd/world`
...
| Game name | join-fast-navezgane_stock | stock |
| Difficulty | 1 | 1 |
...
- tick_overruns: 3
- phase_rejects: 0
- tick mean/p99/max ns: 1906477 / 25165824 / 670534405
...
- stock: 12 file(s), 3413 KiB
- zdtd: 120 file(s), 34059 KiB
- stock keys: Navezgane/join-fast-navezgane_stock/Region/r.0.0.7rg, Navezgane/join-fast-navezgane_stock/Region/r.1.1.7rg, Navezgane/join-fast-navezgane_stock/Region/r.1.2.7rg, Navezgane/join-fast-navezgane_stock/Region/r.2.1.7rg, Navezgane/join-fast-navezgane_stock/Region/r.2.2.7rg, Navezgane/join-fast-navezgane_stock/blockmappings.nim, Navezgane/join-fast-navezgane_stock/decoration.7dt, Navezgane/join-fast-navezgane_stock/itemmappings.nim
