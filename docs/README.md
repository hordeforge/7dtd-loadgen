...
| Measured scale laws | [`../../7dtd-research/docs/measured-scaling.md`](../../7dtd-research/docs/measured-scaling.md) |
...
| [`../../7dtd-research/docs/zig-clone.md`](../../7dtd-research/docs/zig-clone.md) | High-perf Zig dedi architecture |
