...
| Measured scale laws | [`../../research/docs/measured-scaling.md`](../../research/docs/measured-scaling.md) |

Prefer the root README for day-to-day operators. Canonical **wire RE** for clone work lives in research:

| Doc | Role |
|---|---|
| [`../../research/docs/protocol.md`](../../research/docs/protocol.md) | Envelope, join, golden package bodies |
| [`../../research/docs/zig-clone.md`](../../research/docs/zig-clone.md) | High-perf Zig dedi architecture |
